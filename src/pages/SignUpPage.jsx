...
import { MessageCircle, Lock, Mail, User, Loader, Eye, EyeOff, Shield, CheckCircle, Sparkles, Heart, Zap } from "lucide-react";
      ...
      <div className="relative w-full max-w-md lg:max-w-6xl z-10">
        <div className="w-full flex flex-col lg:flex-row bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl shadow-amber-200/50 overflow-hidden border border-amber-100/50">
            ...
            <div className="w-full max-w-md">
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-sm sm:text-base text-gray-600 font-light tracking-wide" style={{fontFamily: 'Georgia, serif'}}>
                  Share your moments, live authentically
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative group">
                    <User className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 transition-colors group-focus-within:text-amber-500" />
                    <input
                      type="text"
              ...
              <div className="mt-6 sm:mt-7 text-center">
                <p className="text-xs sm:text-sm text-gray-600 font-light tracking-wide" style={{fontFamily: 'Georgia, serif'}}>
                  ...
                  <Link to="/login" className="text-amber-600 hover:text-amber-700 font-normal transition-colors">
                    Sign In
                  </Link>
                </p>
              </div>
          ...
          <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 bg-gradient-to-br from-rose-50 via-amber-50 to-orange-50 relative overflow-hidden">
            ...
            {/* Decorative elements */}
            <div className="absolute top-10 right-10 w-40 h-40 bg-rose-300 rounded-full opacity-20 blur-2xl"></div>
            <div className="absolute bottom-20 left-10 w-32 h-32 bg-amber-300 rounded-full opacity-20 blur-2xl"></div>
            
            {/* Floating hearts */}
            <div className="absolute top-20 left-20 text-rose-300 opacity-40 animate-pulse" style={{animationDuration: '3s'}}>
              <Heart className="w-8 h-8 fill-current" />
            </div>
            <div className="absolute bottom-32 right-16 text-amber-300 opacity-40 animate-pulse" style={{animationDuration: '4s', animationDelay: '1s'}}>
            ...
            <div className="relative z-10 text-center max-w-md">
              ...
              <div className="mb-10 relative">
                ...
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-amber-400 to-orange-400 rounded-2xl shadow-xl flex items-center justify-center animate-pulse">
              ...
              <p className="text-gray-600 leading-relaxed mb-10 font-light tracking-wide px-4" style={{fontFamily: 'Georgia, serif'}}>
                Share authentic moments with people who care. Let your feelings out in a safe, warm space.
              </p>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-normal text-gray-800 text-sm tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Share Authentic Moments</h3>
                    <p className="text-gray-600 text-xs font-light tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Express yourself freely and genuinely</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-normal text-gray-800 text-sm tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Safe & Private Space</h3>
                    <p className="text-gray-600 text-xs font-light tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Your moments are encrypted and secure</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-normal text-gray-800 text-sm tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Connect Meaningfully</h3>
                    <p className="text-gray-600 text-xs font-light tracking-wide" style={{fontFamily: 'Georgia, serif'}}>Build real connections that matter</p>
                  </div>
                </div>
              </div>
